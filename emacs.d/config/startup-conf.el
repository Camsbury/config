...
(use-package flycheck-credo :after (elixir-mode))
(use-package flycheck-dialyxir :after (elixir-mode))
(use-package flycheck-elixir :after (elixir-mode))
(use-package flycheck-haskell :after (haskell-mode))
(use-package flycheck-mix :after (elixir-mode))
