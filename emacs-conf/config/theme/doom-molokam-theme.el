;;; doom-molokam-theme.el --- inspired by Tomas Restrepo's Molokam -*- lexical-binding: t; no-byte-compile: t; -*-
;;
;; Added: September 15, 2016 (32f8b5ae5feb)
;; Author: Henrik Lissner <https://github.com/hlissner>
;; Maintainer:
;; Source: https://github.com/tomasr/molokam
;;
;;; Commentary:
;;; Code:
...
(defgroup doom-molokam-theme nil
  "Options for the `doom-molokam' theme."
  :group 'doom-themes)

(defcustom doom-molokam-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-molokam-theme
  :type 'boolean)

(defcustom doom-molokam-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-molokam-theme
  :type 'boolean)

(defcustom doom-molokam-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme doom-molokam
  ...
  ((bg         '("#1f1c1f" "black"   "black"        ))
   ...
   (selection      base5)
   (builtin        orange)
   (comments       (if doom-molokam-brighter-comments violet base5))
   (doc-comments   (if doom-molokam-brighter-comments
   ...
   (-modeline-pad
    (when doom-molokam-padded-modeline
      (if (integerp doom-molokam-padded-modeline) doom-molokam-padded-modeline 4))))
